  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const diagnosis: CancerDiagnosis = {
        ...
        study_type: patient.StudyType || undefined,
        study_date: patient.StudyDate || undefined,
        imaging_type: patient.ImagingType || undefined,
        imaging_date: patient.ImagingDate || undefined,
        chemo_regimen: patient.ChemoRegimen || undefined,
        cycles: patient.Cycles || undefined,
        radio_dose: patient.RadioDose || undefined,
        response: patient.ResponseR || undefined,
      };
