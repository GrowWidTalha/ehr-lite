  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const diagnosis: CancerDiagnosis = {
        ...
        grade: patient.Grade || undefined,
        who_classification: patient.WHOClassification || undefined,
        diagnosis_date: patient.DiagnosisDate || undefined,
        notes: patient.Notes || undefined,
        tumor_size: patient.TumorSize || undefined,
        depth: patient.TumorDepth || undefined,
        margins: patient.Margins || undefined,
        lvi: patient.LVI || undefined,
        pni: patient.PNI || undefined,
        nodes_recovered: patient.NodesDisected || undefined,
        nodes_involved: patient.NodesInvolved || undefined,
        er_status: patient.ERStatus || undefined,
        er_percentAge: patient.ERPercent || undefined,
        pr_status: patient.PRStatus || undefined,
        pr_percentAge: patient.PRPercent || undefined,
        her2_status: patient.HER2Status || undefined,
        ki67_percentAge: patient.Ki67Percent || undefined,
        findings: patient.Findings || undefined,
        indication: patient.Indication || undefined,
        plan_type: patient.PlanType || undefined,
        surgery_planned: patient.SurgeryPlanned || undefined,
        neoadjuvant_chemo: patient.NeoadjuvantChemo || undefined,
      };
